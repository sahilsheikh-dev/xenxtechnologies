...
export function ContactFormComponent() {
  ...
  return (
    <div className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input text-left">
      <form className="my-8" onSubmit={handleSubmit}>
        ...
        <LabelInputContainer className="mb-4">
          ...
          <Input id="number" placeholder="+91 1234567890" type="text" />
        </LabelInputContainer>
